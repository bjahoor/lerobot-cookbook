...
- If the follower jerks badly or one joint refuses to move, the most likely cause is calibration drift on that joint — re-run [calibration](01-calibration.md) for the affected arm.
